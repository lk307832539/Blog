...
public class ShiroConfiguration {
    ...
    private static final Logger log = LogManager.getLogger(ShiroConfiguration.class);
...
//    }
    ...
    @Bean(name = "authRealm")
    public CustomAuthorizingRealm authRealm(EhCacheManager cacheManager) {
        CustomAuthorizingRealm authRealm = new CustomAuthorizingRealm();
        authRealm.setCacheManager(cacheManager);
        return authRealm;
    }

    @Bean(name = "securityManager")
    public DefaultWebSecurityManager getDefaultWebSecurityManager(CustomAuthorizingRealm authRealm) {
